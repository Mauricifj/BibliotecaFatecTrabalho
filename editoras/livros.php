...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        if (!$procedure->execute()) {
            $erro = "Não foi possível mostrar os livros desta editora";
        }
    } catch (PDOException $exception) {
        $erro = "Erro ao mostrar os livros desta editora";
    } ?>
    ...
    <div class="container text-center">
        <div class="card">
            <div class="card-body">
                ...
                ?>
                <h2 class="font-weight-light">LIVROS DA EDITORA</h2>
                <a href="index.php" class="btn btn-danger m-3 float-left">Voltar</a>
                <table id="livrosEditora" class="table table-responsive-md">
                    <thead>
                    <tr>
                        <th>Código</th>
                        <th>Nome</th>
